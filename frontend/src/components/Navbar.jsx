        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:block text-right bg-white/5 px-4 py-2 rounded-lg border border-white/10">
              <div className="text-sm font-semibold text-white flex flex-col items-end">
                <span>{usuario?.nome}</span>
                {empresa?.nome && (
                  <span className="text-xs text-accent-yellow font-bold">{empresa.nome}</span>
                )}
              </div>
          ...
          <div className="px-4 py-3 space-y-2">
            ...
            <div className="md:hidden mt-4 pt-4 border-t border-white/10">
              <div className="bg-white/5 px-4 py-3 rounded-lg border border-white/10 mb-3">
                <div className="text-sm font-semibold text-white flex flex-col items-start">
                  <span>{usuario?.nome}</span>
                  {empresa?.nome && (
                    <span className="text-xs text-accent-yellow font-bold">{empresa.nome}</span>
                  )}
